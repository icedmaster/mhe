...
public:
    bool init(mhe::game::Engine& engine, const mhe::game::GameSceneDesc& /*desc*/)
    {
        ...
        mhe::setup_node(node, material_system, engine.context(), engine.scene_context(), mhe::FilePath("test"), mhe::FilePath("test.tga"));
        mhe::setup_node(node2, material_system, engine.context(), engine.scene_context(), mhe::FilePath("test"), mhe::string("test.tga"));
        mhe::setup_node(node3, material_system, engine.context(), engine.scene_context(), mhe::FilePath("test"), mhe::string("test.tga"));
