...
void Driver::render(const Context& context, const NodeInstance* nodes, size_t count)
{
	...
	for (size_t i = 0; i < count; ++i)
		render_node(context, nodes[i].node);
}

void Driver::render(const Context& context, const Node* nodes, size_t count)
{
	ProfilerElement pe("driver.render_pass");
	for (size_t i = 0; i < count; ++i)
		render_node(context, nodes[i]);
}

void Driver::render_node(const Context& context, const Node& node)
{
