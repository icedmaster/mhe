	...
	namespace game
	{
		class Engine
		{
			public:
				...
				{
					public:
						virtual void OnStart(Engine* const engine)  {}
						virtual void OnRun(Engine * const engine)   {}
						virtual void OnClose(Engine * const engine) {}
				};
			private:
				WindowSystem ws_;
				InputSystem is_;
			...
			public:
				...
				void setScene(const boost::shared_ptr<Scene>& scene)
				{
					scene_ = scene;
				}
		};
