	...
	namespace utils
	{
		...
		class OptionsParser
		{
			...
			public:
				...
				bool getString(const std::string& name, std::string& value, const std::string& def_value) const;
				bool getInteger(const std::string& name, int& value, int def_value) const;
				bool getBool(const std::string& name, bool& value, bool def_value) const;
				bool getFloat(const std::string& name, float& value, float def_value) const;
				template <class Type>
